  ...
  return (
    <div className="max-w-[240px]">
        ...
        <div className="flex flex-col gap-2 mt-5">
            <input type="text" className="bg-gray-200 rounded-md w-full max-w-[250px] p-2 outline-none" placeholder="Compra de supermercado..." />
            <input type="text" className="bg-gray-200 rounded-md w-full max-w-[250px] p-2 outline-none" placeholder="00.00"/>
